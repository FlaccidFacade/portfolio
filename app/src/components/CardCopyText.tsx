...
interface CardCopyTextProps {
  text: string;
}

const CardCopyText: React.FC<CardCopyTextProps> = ({ text }) => {
    ...
    <div className="max-w-md">
      <div className="relative">
        ...
        <input
          ...
          type="text"
          className="col-span bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-2.5 py-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
          value={text}
          disabled
          readOnly
        />
